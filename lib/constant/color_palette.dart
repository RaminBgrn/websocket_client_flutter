...
class ColorPalette {
  static const Map<int, Color> myGrey = {
    25: Color(0xFFFCFCFD),
    50: Color(0xFFF9FAFB),
  ...
  static const Map<int, Color> myGreen = {
    25: Color(0xFFF6FEF9),
    50: Color(0xFFECFDF3),
  ...
  static const Map<int, Color> myOrange = {
    25: Color(0xFFFFFCF5),
    50: Color(0xFFFFFAEB),
  ...
  static const Map<int, Color> myRed = {
    25: Color(0xFFFFFBFA),
    50: Color(0xFFFEF3F2),
  ...
  static const Map<int, Color> myPurple = {
    25: Color(0xFFFCFAFF),
    50: Color(0xFFF9F5FF),
    100: Color(0xFFF4EBFF),
    200: Color(0xFFE0D7FE),
  ...
  static const Map<int, Color> myBlueGrey = {
    25: Color(0xFFFCFCFD),
    50: Color(0xFFF8F9FC),
  ...
  static const Map<int, Color> myBlueLight = {
    25: Color(0xFFF5FBFF),
    50: Color(0xFFF0F9FF),
  ...
  static const Map<int, Color> myBlue = {
    25: Color(0xFFF5FAFF),
    50: Color(0xFFEFF8FF),
    ...
    700: Color(0xFF157CD3),
    800: Color(0xFF1849A9),
    900: Color(0xFF194185),
  };

  static const Map<int, Color> myIndigo = {
    25: Color(0xFFF5F8FF),
    50: Color(0xFFEEF4FF),
  ...
  static const Map<int, Color> myPink = {
    25: Color(0xFFFEF6FB),
    50: Color(0xFFFDF2FA),
  ...
  static const Map<int, Color> myRose = {
    25: Color(0xFFFFFAF5),
    50: Color(0xFFFFF1F3),
